...
class SonarPotentialField(Node):
    ...
    def __init__(self, sonar_topic = '/scan'):
        ...
        self.velocity_command_topic_name = '/mavros/rc/override'


        # Sonar Subscriber
        self.sonar_sub = self.create_subscription(LaserScan, self.sonar_sub_name, self.callback_sonar, 10)
        # Velocity publisher
        self.steering_signal = self.create_publisher(OverrideRCIn, self.velocity_command_topic_name, 10)
...
def main(args=None):
    ...
    avoid_boi = SonarPotentialField(sonar_topic = '/scan')
